...
describe('LoginPage', () => {
  ...
  it('should redirect to register screen', () => {
  ...
  it('should recover email/password on forgot email/password', () => {
    // spyOn(authService, 'recoverEmailPassword').and.returnValue(
    //   new Observable(() => {})
    // );
  ...
  it('given user is recovering password, when success, the hide loading and show success message', () => {
  ...
  it('given user is recovering password, when fail, the hide loading and show error message', () => {
    spyOn(toastController, 'create').and.returnValue(<any>Promise.resolve({ present: () => {} }));
    fixture.detectChanges();
    store.dispatch(recoverPassword({email: 'any@email.com'}));
