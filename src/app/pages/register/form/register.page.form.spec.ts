...
describe('RegisterPageForm', ()=> {
    ...
    it('should password less tahn 6 characters be invalid', () => {
    ...
    it('should form be valid', () => {
        ...
        form.get('email').setValue('anyName@email.com');
        form.get('password').setValue('anyPassword');
        ...
        form.get('address').get('neighborhood').setValue('any neighbodhood');
