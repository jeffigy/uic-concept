...
describe('ErrorMessageComponent', () => {
  ...
  it('should show error message on field touched and if theres error', () => {
  ...
  it('should hide error message on fiield touched and has error, but it is a different error', () => {
    component.field = new FormGroup({anyField: new FormControl()});
    component.field.markAllAsTouched();
    component.field.setErrors({anyError: true});
  ...
  // it('should show error mesage on field touched and email error present', () => {
